...
This will install pyrepseq with all optional dependencies (TCRdist and SCEPTR support are optional). Depending on whether dependencies are already installed this might take a few minutes.
